          ...
          recent.map((tx) => (
            <div key={tx._id} className="group flex items-center justify-between rounded-2xl border border-slate-100 bg-slate-50/50 p-3 md:p-4 transition-all hover:bg-slate-50">
              <div className="flex items-center gap-3 md:gap-4 min-w-0">
                <div className={`shrink-0 flex h-9 w-9 md:h-10 md:w-10 items-center justify-center rounded-xl ${
                ...
                <div className="min-w-0">
                  <p className="font-bold text-text-main text-sm group-hover:text-primary transition-colors truncate">{tx.title}</p>
